...
function PrivacyContent() {
  return (
    <div className="legal-card" style={cardStyle}>
      ...
      <p style={pStyle}>لا نبيع بياناتك. قد نشاركها مع مزودي الخدمة (شحن، دفع، تحليلات)، الجهات الرسمية عند الأمر القضائي، أو الشركات التابعة داخل المجموعة الذهبية المتحدة.</p>
      ...
      <p style={pStyle}>نستخدم كوكيز ضرورية، تحليلية (Google Analytics)، وتسويقية (بعد الموافقة). يمكنك إدارة التفضيلات من المتصفح.</p>
