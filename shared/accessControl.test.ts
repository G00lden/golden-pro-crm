...
const expected: Record<"admin" | "manager" | "viewer", Record<AppCapability, boolean>> = {
  admin: {
    ...
    "mobile.calls.export": true,
    "mobile.calls.bulk": true,
    "mobile.whatsapp.send": true,
    "mobile.contacts.manage": true,
    "mobile.contacts.sync": true,
    "mobile.sims.manage": true,
    ...
    "maintenance.requests.view": true,
    "maintenance.requests.manage": true,
    "maintenance.requests.close_override": true,
  ...
  manager: {
    ...
    "maintenance.requests.view": true,
    "maintenance.requests.manage": true,
    "maintenance.requests.close_override": false,
    "operations.prepare": true,
    "demo.seed": false,
  },
  viewer: {
    ...
    "mobile.calls.export": false,
    "mobile.calls.bulk": false,
    "mobile.whatsapp.send": false,
    "mobile.contacts.manage": false,
    "mobile.contacts.sync": false,
    "mobile.sims.manage": false,
    ...
    "maintenance.requests.view": false,
    "maintenance.requests.manage": false,
    "maintenance.requests.close_override": false,
