...
const files = [
  ...
  "scripts/maintenance-request.test.mjs",
  ...
  "shared/productCatalogState.test.ts",
  "shared/accessControl.test.ts",
  ...
  "server/whatsappStatusVisibility.test.ts",
  ...
  "src/publicLead.test.ts",
  "src/callSystemDelete.test.ts",
  "src/outboundAction.test.ts",
