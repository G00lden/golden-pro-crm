...
## آخر تحديث: 2026-07-13 — زين → Unifonic → واتساب ويب للمكالمات غير المجابة [Codex]

- أضيف وضع `unavailable_reply` الافتراضي: رسالة صوتية داخل/خارج الدوام ثم إنهاء المكالمة دون DTMF.
- أضيفت الحالات الموحدة، جدول الدوام القابل للتعديل، مهمة متابعة خلال 5 دقائق أو عند بداية الدوام التالي، ومنع التكرار 10 دقائق.
- أضيف طابور `call_action_runs` الدائم؛ انقطاع واتساب لا يفقد الرسالة، وينشئ مهمة عاجلة للمدير، ويستأنف بعد QR.
- أصبحت أعلام الإرسال تُحدّث عند الإرسال الحقيقي فقط؛ `dry_run` لا يدّعي وصول الرسالة.
- أضيف دمج أحداث أندرويد وUnifonic ومنع تكرار معرف الحدث/Webhook، وربط رد العميل بمهمته.
- حُدّثت شاشة «نظام المكالمات» لإدارة الدوام والنصوص والحالات واختبار كل تصنيف ومراقبة الطابور.
