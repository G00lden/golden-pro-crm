...
**لم يُغيَّر عمدًا** (بنود ضعيفة/غير مؤكدة في `public/quotation-template.html`): نسبة الدفع الفارغة → 70/30 (سلوك مقصود، الصفر الصريح محفوظ)، وتسمية «الإجمالي شامل الضريبة» (PLAUSIBLE — قد تكون الأسعار المُدخلة شاملة الضريبة أصلًا؛ يحتاج قرارًا هل الأسعار gross أم net قبل تغيير التسمية).
