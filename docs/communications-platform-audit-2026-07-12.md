...
> تحديث المعالجة: نُفّذت إصلاحات الأساس في `1.2.0`، ثم أُضيف محرك الحملات الآمنة في `1.3.0`: الموافقات، الإلغاء، الجمهور، الجدولة، حدود التكرار، الإيقاف والاستكمال، وربط إيصالات Meta. التفاصيل في `docs/communications-release-1.2.0-ar.md` و`docs/communications-release-1.3.0-ar.md`. بقيت إعدادات الإنتاج وA/B والموصل الخارجي الحقيقي لـOdoo خارج هذا الإصدار.
